...
var oe = { current: null },
	yr = { transition: null },
	hc = { ReactCurrentDispatcher: oe, ReactCurrentBatchConfig: yr, ReactCurrentOwner: $u }
T.Children = {
	map: bt,
		...
		(e.unstable_scheduleCallback = function (C, N, z) {
			...
			return (
				...
				z > H
					? ((C.sortIndex = z),
					  n(c, C),
					  t(s) === null && C === t(c) && (k ? (f(P), (P = -1)) : (k = !0), vl(h, z - H)))
...
var He = !(
	...
	Uo = {}
function gc(e) {
	return Hl.call(Uo, e) ? !0 : Hl.call(jo, e) ? !1 : yc.test(e) ? (Uo[e] = !0) : ((jo[e] = !0), !1)
}
function wc(e, n, t, r) {
...
function kc(e, n, t, r) {
	if (n === null || typeof n == 'undefined' || wc(e, n, t, r)) return !0
	if (r) return !1
	if (t !== null)
		switch (t.type) {
			case 3:
...
function gs(e) {
	return (e = Lc(e)), e !== null ? ws(e) : null
}
function ws(e) {
...
function Ju(e, n, t, r) {
	if (Mr) {
		...
		if (l === null) Ol(e, n, r, Dr, t), Yo(e, r)
			...
			for (; l !== null; ) {
				var u = Gt(l)
				if ((u !== null && xs(u), (u = iu(e, n, t, r)), u === null && Ol(e, n, r, Dr, t), u === l))
					break
				l = u
			}
...
function Is(e, n, t, r) {
	ds(r),
		(n = Ir(n, 'onChange')),
		0 < n.length &&
			((t = new bu('onChange', 'change', null, t, r)), e.push({ event: t, listeners: n }))
}
var Ct = null,
	It = null
function Sf(e) {
...
function js(e) {
	if (e.propertyName === 'value' && el(It)) {
		var n = []
		Is(n, It, e, Yu(e)), hs(Sf, n)
	}
}
function Cf(e, n, t) {
	e === 'focusin'
		? (ri(), (Ct = n), (It = t), Ct.attachEvent('onpropertychange', js))
		: e === 'focusout' && ri()
}
function _f(e) {
	...
	if (!e[sr]) {
		;(e[sr] = !0),
			es.forEach(function (t) {
				t !== 'selectionchange' && (Of.has(t) || Rl(t, !1, e), Rl(t, !0, e))
			})
		...
		if ((n & 7) === 0) {
			e: {
				if (
					...
					p && t !== nu && (w = t.relatedTarget || t.fromElement) && (wn(w) || w[We]))
				)
					break e
				if (
					(g || p) &&
					...
					if (
						...
						(e === 'pointerout' || e === 'pointerover') &&
							((k = qo), (h = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
						(F = g == null ? p : jn(g)),
						(d = w == null ? p : jn(w)),
			...
			switch (((_ = c ? jn(c) : window), e)) {
				case 'focusin':
					;(ni(_) || _.contentEditable === 'true') && ((In = _), (su = c), (_t = null))
					break
				case 'focusout':
					_t = su = In = null
					break
			...
			P &&
				(Os &&
					...
					(Dn || P !== 'onCompositionStart'
						...
						: ((be = v), (qu = 'value' in be ? be.value : be.textContent), (Dn = !0))),
				(_ = Ir(c, P)),
				0 < _.length &&
	...
	if (j) {
		...
		if (n) {
			...
			if (!vi(e, n)) {
				...
				n = ln(t.nextSibling)
				var r = ve
				n && vi(e, n) ? Js(r, t) : ((e.flags = (e.flags & -4097) | 2), (j = !1), (ve = e))
			}
		} else {
			if (hu(e)) throw Error(y(418))
...
function ra(e) {
	...
	function s(f, a, d, h) {
		...
		return E === Mn
			...
			: a !== null &&
			  (a.elementType === E ||
					(typeof E == 'object' && E !== null && E.$$typeof === Ge && Si(E) === a.type))
						...
						for (var E = d.key, _ = a; _ !== null; ) {
							if (_.key === E) {
								if (((E = d.type), E === Mn)) {
									...
									_.elementType === E ||
									(typeof E == 'object' && E !== null && E.$$typeof === Ge && Si(E) === _.type)
								) {
									t(f, _.sibling),
										(a = l(_, d.props)),
										(a.ref = pt(f, _, d)),
...
function ka(e, n, t) {
	return (Pn & 21) === 0
		...
		: (Oe(t, n) || ((t = Cs()), ($.lanes |= t), (Nn |= t), (e.baseState = !0)), n)
}
function Hf(e, n) {
	var t = O
	;(O = t !== 0 && 4 > t ? t : 4), e(!0)
		...
		if (e.lanes === 0 && (u === null || u.lanes === 0) && ((u = n.lastRenderedReducer), u !== null))
			try {
				...
				if (((l.hasEagerState = !0), (l.eagerState = i), Oe(i, o))) {
					var s = n.interleaved
					s === null ? ((l.next = l), ao(n)) : ((l.next = s.next), (s.next = l)),
						(n.interleaved = l)
					return
				}
			} catch {
			...
			return (n.flags & 128) !== 0
				...
				: ((r = r !== null),
				  r !== (e !== null && e.memoizedState !== null) &&
						...
						((n.child.flags |= 8192),
						(n.mode & 1) !== 0 &&
							(e === null || (U.current & 1) !== 0 ? Y === 0 && (Y = 3) : Po())),
...
function Fa(e) {
	...
	n !== null && ((e.alternate = null), Fa(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null && (delete n[Ie], delete n[$t], delete n[mu], delete n[Uf], delete n[$f])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
...
function Va(e, n, t) {
	for (var r = (e.mode & 1) !== 0; S !== null; ) {
		...
		if (l.tag === 22 && r) {
			...
			Ii(e)
		} else (l.subtreeFlags & 8772) !== 0 && u !== null ? ((u.return = l), (S = u)) : Ii(e)
	}
}
function Ii(e) {
	for (; S !== null; ) {
...
function sn(e) {
	return (e.mode & 1) === 0
		...
		: Af.transition !== null
		? (Pr === 0 && (Pr = Cs()), Pr)
		: ((e = O), e !== 0 || ((e = window.event), (e = e === void 0 ? 16 : Ls(e.type))), e)
}
function Re(e, n, t, r) {
	if (50 < zt) throw ((zt = 0), (Ou = null), Error(y(185)))
	Yt(e, t, r),
		((R & 2) === 0 || e !== Z) &&
			(e === Z && ((R & 2) === 0 && (il |= t), Y === 4 && qe(e, q)),
			de(e, r),
			t === 1 && R === 0 && (n.mode & 1) === 0 && ((tt = W() + 500), rl && mn()))
}
function de(e, n) {
	...
	if (r === 0) t !== null && Ko(t), (e.callbackNode = null), (e.callbackPriority = 0)
		...
		if ((t != null && Ko(t), n === 1))
			e.tag === 0 ? Vf(Ui.bind(null, e)) : Gs(Ui.bind(null, e)),
				Ff(function () {
					;(R & 6) === 0 && mn()
				}),
				(t = null)
	...
	if (n !== 0) {
		...
		if (n === 6) qe(e, r)
			...
			if (
				...
				(r & 30) === 0 &&
					!ud(l) &&
					((n = Zr(e, r)), n === 2 && ((u = uu(e)), u !== 0 && ((r = u), (n = Mu(e, u)))), n === 1))
			)
				throw ((t = Qt), En(e, 0), qe(e, r), de(e, W()), t)
...
function qe(e, n) {
	for (
		n &= ~Eo, n &= ~il, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes;
		0 < n;
		...
		try {
			...
			e: {
				...
				if (
					...
					var F = xi(o)
					if (F !== null) {
						;(F.flags & 65536) === 0 && (F.flags |= 256), Pi(F, o, i, u, n), uo(nt(s, i))
						break e
					}
				}
...
function Po() {
	;(Y === 0 || Y === 3 || Y === 2) && (Y = 4),
		Z === null || ((Nn & 268435455) === 0 && (il & 268435455) === 0) || qe(Z, q)
}
function Zr(e, n) {
	var t = R
	R |= 2
...
function Wa(e) {
	...
	;(e.memoizedProps = e.pendingProps), n === null ? Qa(e) : (Q = n), (So.current = null)
}
function Qa(e) {
	var n = e
	do {
	...
	if (en !== null) {
		...
		try {
			if (((Ee.transition = null), (O = 16 > e ? 16 : e), en === null)) var r = !1
				...
				if (((e = en), (en = null), (Gr = 0), (R & 6) !== 0)) throw Error(y(331))
				var l = R
...
function ad(e, n, t) {
	...
	r !== null && r.delete(n),
		...
		Z === e &&
			(q & t) === t &&
			(Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - Co) ? En(e, 0) : (Eo |= t)),
		de(e, n)
}
function Ka(e, n) {
	n === 0 &&
...
Ya = function (e, n, t) {
	if (e !== null)
		if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0
			...
			if ((e.lanes & t) === 0 && (n.flags & 128) === 0) return (ae = !1), qf(e, n, t)
			ae = (e.flags & 131072) !== 0
		}
	else (ae = !1), j && (n.flags & 1048576) !== 0 && Zs(n, Vr, n.index)
	...
	switch (e.tag) {
		case 3:
			...
			if (n.current.memoizedState.isDehydrated) {
				...
				t !== 0 && (Gu(n, t | 1), de(n, W()), (R & 6) === 0 && ((tt = W() + 500), mn()))
			}
			break
		case 13:
			zn(function () {
...
ms = _o
vs = zn
var gd = { usingClientEntryPoint: !1, Events: [Gt, jn, tl, ds, ps, _o] },
	vt = {
...
ye.hydrateRoot = function (e, n, t) {
	...
	if (
		...
		(n = Za(n, null, e, 1, t != null ? t : null, l, !1, u, o)),
		(e[We] = n.current),
		jt(e),
		r)
	)
...
var kd = '/assets/logo.229f2633.svg'
var Oo = { exports: {} },
	pl = {}
/**
 * @license React
...
function ec(e, n, t) {
	...
	return { $$typeof: Ed, type: e, key: u, ref: o, props: l, _owner: xd.current }
}
pl.Fragment = Cd
pl.jsx = ec
pl.jsxs = ec
Oo.exports = pl
const Iu = Oo.exports.jsx,
	Nd = Oo.exports.jsxs
function zd() {
	return Nd('div', {
		children: [
			Iu('img', { src: kd, alt: 'React Logo', width: 200 }),
			Iu('p', { children: 'Hello from reacts world and it works perfectly' }),
		],
	})
}
const Td = document.getElementById('app'),
	Ld = ba(Td)
Ld.render(Iu(zd, {}))
